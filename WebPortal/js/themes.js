...
const ThemeManager = {
    ...
    themes: {
        ...
        'irrigation-blue': {
            name: 'Macavation',
            icon: 'fa-droplet',
            description: 'Gold and aqua – brand palette',
            isDark: false,
            colors: {
                '--phoenix-primary': '#927325',
                '--phoenix-primary-rgb': '146, 115, 37',
                '--phoenix-secondary': '#e9ecef',
                '--phoenix-secondary-rgb': '233, 236, 239',
                '--phoenix-tertiary': '#B0DCE7',
                '--phoenix-tertiary-rgb': '176, 220, 231',
                ...
                '--phoenix-danger': '#ef4444',
                '--phoenix-danger-rgb': '239, 68, 68',
                '--phoenix-light': '#e9ecef',
                '--phoenix-light-rgb': '233, 236, 239',
                '--phoenix-dark': '#6b5519',
                '--phoenix-dark-rgb': '107, 85, 25',
                '--phoenix-body-bg': '#f0fafb',
                '--phoenix-card-bg': '#ffffff',
                '--phoenix-text-color': '#1e2d2e',
                '--phoenix-border-color': '#B0DCE7',
                '--theme-sidebar-bg': '#927325',
                '--theme-sidebar-text': 'rgba(255, 255, 255, 0.9)',
                '--theme-sidebar-active': '#B0DCE7',
                '--theme-sidebar-hover': 'rgba(176, 220, 231, 0.2)',
                '--theme-navbar-gradient': 'linear-gradient(135deg, #927325, #B0DCE7)',
                '--theme-accent': '#B0DCE7'
            }
        },
        'twilight-field': {
