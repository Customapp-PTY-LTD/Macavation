/**
 * Kernel Production Job Card Module
 * Job card modal: form, sound kernel/butter grade rows, calculations, save.
 * Pattern: same as hatchability.js (return object, arrow functions, const scope = _module).
 */
var _kernelProductionJobCard = function () {
    'use strict';
    return {
        init: () => {
            const scope = _kernelProductionJobCard;
        ...
        showJobCardViewModal: (jobCardId) => {
