...
Run this migration on Supabase so **contacts** (`nis_supplier`) and **kernel** `grower_name` match the official supplier list (e.g. Familie, Empirestate, Dougvale, Uluhlata, Sharwan Singh, Nombhaba, Nseze, Ropa Miller; Supplier #55 **Big Five Mac**).
