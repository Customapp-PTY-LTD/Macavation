-- Remove ambiguous upsert_kernel_job_card overloads (PostgREST cannot choose between 3- and 4-arg signatures).
-- Canonical function: 4 parameters with defaults (matches 20260521180000_kernel_jobcard_approve_submit_action).
