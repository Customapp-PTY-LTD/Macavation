-- Consolidate release_kernel_to_production into a single function (optional p_silos)
-- to resolve "Could not choose the best candidate function" when both (p_kernel_id)
-- and (p_kernel_id, p_silos) existed.
...
BEGIN
    ...
    -- Optional: assign to silos (same logic as assign_kernel_to_silos)
