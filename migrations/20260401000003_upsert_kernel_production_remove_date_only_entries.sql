-- Remove date-only production stage entries when users clear a saved day back to blank.
-- This keeps cleared production slots from reappearing after reopening the modal.
