-- Fix BLO: we had stored sheet Cartons as kg and sheet Kilograms as cartons. Swap to match sheet.
-- Sheet Cartons column -> bt_low_cartons; stored kg = cartons * 11.34.
-- Sheet values (cartons): 44.2.25.28=27, 56.1.25.39=10, 51.1.25.31=3, 7.7.25.32=3, 54.6.25.37=13,
-- 55.1.25.38=53, 44.2.25.40=15, 56.1.25.45=3, 23.6.25.46=35.
...
BEGIN
    FOR rec IN (SELECT * FROM (VALUES
        ...
        ('56.1.25.45', 3),
        ('23.6.25.46', 35)
    ) AS t(batch_num, sheet_cartons))
    LOOP
        v_cartons := rec.sheet_cartons;
