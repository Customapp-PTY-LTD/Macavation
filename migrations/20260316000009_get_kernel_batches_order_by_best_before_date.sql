-- Order kernel batches by best before date: closest (soonest) at top, furthest at bottom.
-- Redefines get_kernel_batches with ORDER BY best_before_date ASC NULLS LAST, batch_id ASC.
...
BEGIN
    ...
    ORDER BY COALESCE((NULLIF(k.job_card_data->>'best_before_date', ''))::date, ((NULLIF(k.job_card_data->>'packing_completion_date', ''))::date + interval '18 months')::date) ASC NULLS LAST, b.batch_id ASC
