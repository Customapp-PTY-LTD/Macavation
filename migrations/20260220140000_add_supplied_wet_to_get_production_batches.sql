-- Add supplied_wet_kg to get_production_batches (from linked sample submission).
-- Used on Grower Intake to compare actual (wet_nis_received_kg) vs supplied without showing supplied column.
