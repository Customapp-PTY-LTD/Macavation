-- Batch History dispatch_orders: also match dispatch lines by human batch_number when kernel_id is blank
-- (legacy / edited JSON lines). kernel_id + KernelId still preferred.
