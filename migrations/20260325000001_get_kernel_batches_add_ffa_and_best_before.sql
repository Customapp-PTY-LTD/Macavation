-- Add FFA and best_before_date to get_kernel_batches for Kernel Stock by style grid.
-- FFA from kernel.qa_data->>'ffa'; best_before from job_card_data->>'best_before_date' or packing_completion_date + 18 months.
...
BEGIN
    ...
    SELECT
        ...
        (NULLIF(k.qa_data->>'ffa', ''))::numeric AS ffa,
