...
function getDefaultTestData(): TestDataSet {
  return {
    users: {
      ...
      generalManager: {
        email: 'jon.walters@macavation.co.za',
        password: process.env.GENERAL_MANAGER_PASSWORD || 'password1',
        role: 'General Manager',
        expected_dashboard: '/dashboard',
      },
      productionManager: {
        email: 'mark.payne@macavation.co.za',
        password: process.env.PRODUCTION_MANAGER_PASSWORD || 'password1',
        role: 'Production Manager',
        expected_dashboard: '/kernel-production',
      },
      qaSupervsor: {
        email: 'simone.naidu@macavation.co.za',
        password: process.env.QA_SUPERVISOR_PASSWORD || 'password1',
        role: 'QA Supervisor',
        expected_dashboard: '/quality-assurance',
      },
      salesExecutive: {
        email: 'peter.symons@macavation.co.za',
        password: process.env.SALES_EXECUTIVE_PASSWORD || 'password1',
      ...
      officeAdministrator: {
        email: 'josslyn.pillay@macavation.co.za',
        password: process.env.OFFICE_ADMINISTRATOR_PASSWORD || 'password1',
